...
$aLang = [
    ...
    'OXPS_PAYPAL_BILLING_PLAN_NAME'                => 'Billing Cycle Name',
    'OXPS_PAYPAL_BILLING_PLAN_TYPE'                => 'Type',
    'OXPS_PAYPAL_BILLING_PLAN_FIXED'               => 'Fixed',
    'OXPS_PAYPAL_BILLING_PLAN_INFINITE'            => 'Infinite',
    ...
    'OXPS_PAYPAL_BILLING_PLAN_BILLING_CYCLES'      => 'Assigned Billing Cycles',
    'OXPS_PAYPAL_BILLING_PLAN_PRICE'               => 'Price',
    ...
    'OXPS_PAYPAL_BILLING_PLAN_SEQUENCE'            => 'Sequence',
    'OXPS_PAYPAL_BILLING_PLAN_CYCLES'              => 'Cycles',
    'OXPS_PAYPAL_BILLING_PLAN_TOTAL_CYCLES'        => 'Total Cycles',
    'OXPS_PAYPAL_BILLING_PLAN_ACTIONS'             => 'Actions',
    'OXPS_PAYPAL_BILLING_PLAN_NO_PLANS'            => 'No Billing Plans',
    'OXPS_PAYPAL_BILLING_PLAN_ADD'                 => 'Add Billing Plan',
    'OXPS_PAYPAL_BILLING_PLAN_ADD_CYCLES'          => 'Add Billing Cycles',
    'OXPS_PAYPAL_BILLING_PLAN_YES'                 => 'Yes',
    'OXPS_PAYPAL_BILLING_PLAN_NO'                  => 'No',
    'OXPS_PAYPAL_BILLING_PLAN_SUBSCRIPTION_PROD'   => 'Subscription Product',
    ...
    'OXPS_PAYPAL_ADMIN_AREA_1'                     => 'Province, State, or ISO-subdivision',
    'OXPS_PAYPAL_ADMIN_AREA_2'                     => 'City',
    'OXPS_PAYPAL_ADMIN_AREA_3'                     => 'Sub-locality, Suburb, Neighborhood or District',
    'OXPS_PAYPAL_ADMIN_AREA_4'                     => 'The neighborhood, ward, or district',
    ...
    'OXPS_PAYPAL_SUBSCRIPTIONS_SHORT'              => 'PP Subscr.',
    ...
    'HELP_OSC_PAYPAL_BANNER_STARTPAGESELECTOR'      => 'Default values for Flow and Wave themes are: \'#wrapper .row\' and \'#wrapper .container\'. After these CSS selectors the banner is displayed.',
    ...
    'HELP_OSC_PAYPAL_BANNER_CATEGORYPAGESELECTOR'   => 'Default values for Flow and Wave themes are: \'.page-header\' and \'.page-header\'. After these CSS selectors the banner is displayed.',
    ...
    'HELP_OSC_PAYPAL_BANNER_SEARCHRESULTSPAGESELECTOR' => 'Default values for Flow and Wave themes are: \'#content .page-header .clearfix\' and \'.page-header\'. After these CSS selectors the banner is displayed.',
    ...
    'HELP_OSC_PAYPAL_BANNER_DETAILSPAGESELECTOR'    => 'Default values for Flow and Wave themes are: \'.detailsParams\' and \'#detailsItemsPager\'. After these CSS selectors the banner is displayed.',
    ...
    'HELP_OSC_PAYPAL_BANNER_CARTPAGESELECTOR'       => 'Default values for Flow and Wave themes are: \'.cart-buttons\' and \'.cart-buttons\'. After these CSS selectors the banner is displayed.',
    'OSC_PAYPAL_BANNER_PAYMENTPAGESELECTOR'         => 'CSS selector of the "Pay" page (checkout step 3) after which the banner is displayed.',
    'HELP_OSC_PAYPAL_BANNER_PAYMENTPAGESELECTOR'    => 'Default values for Flow and Wave themes are: \'.checkoutSteps ~ .spacer\' and \'.checkout-steps\'. After these CSS selectors the banner is displayed.',
    // <-- PSPAYPAL-491
];
