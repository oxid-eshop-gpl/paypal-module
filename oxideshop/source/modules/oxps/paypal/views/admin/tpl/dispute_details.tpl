...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2>
                [{$dispute->dispute_id}]: [{oxmultilang ident="OXPS_PAYPAL_DISPUTE_REASON_"|cat:$dispute->reason}]
                <small>([{$dispute->create_time|date_format:"%Y-%m-%d %H:%M:%S"}])</small>
            </h2>
            <h4>
                [{oxmultilang ident="OXPS_PAYPAL_DISPUTE_STATUS_"|cat:$dispute->status}]
    ...
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="#" id="history-tab">[{oxmultilang ident="OXPS_PAYPAL_HISTORY"}]</a>
        </li>
        [{if $dispute->status !== 'RESOLVED' && $dispute->status !== 'UNDER_REVIEW'}]
            <li class="active">
                <a href="#" id="messages-tab">
                    [{oxmultilang ident="OXPS_PAYPAL_MESSAGES"}]
                </a>
            </li>
            <li>
                <a href="#" id="offer-tab">
                    [{oxmultilang ident="OXPS_PAYPAL_MAKE_OFFER"}]
                </a>
            </li>
            <li>
                <a href="#" id="escalate-tab">
                    [{oxmultilang ident="OXPS_PAYPAL_ESCALATE"}]
                </a>
            </li>
            <li>
                <a href="#" id="evidence-tab">
                    [{oxmultilang ident="OXPS_PAYPAL_PROVIDE_EVIDENCE"}]
                </a>
            </li>
        [{/if}]
    </ul>
    ...
    <div class="pptab" id="history">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="ppaltmessages">
                    [{oxmultilang ident="OXPS_PAYPAL_HISTORY"}]
                </h3>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="messageRow">
                        <h4>
                            [{oxmultilang ident="OXPS_PAYPAL_"|cat:$dispute->dispute_outcome->outcome_code}]
                            <small>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="messageRow">
                    <h4>
                        [{oxmultilang ident="OXPS_PAYPAL_CREATED" suffix="COLON"}]
                        <small>
            ...
            <div class="col-lg-12">
                [{foreach from=$dispute->messages|@array_reverse item="message"}]
                    [{if $message->posted_by == 'SELLER'}]
                        <div class="messageRow">
                            <h4>
                                [{oxmultilang ident="OXPS_PAYPAL_ME" suffix="COLON"}]
                                <small>
                            ...
                            <select name="evidenceType[{$l}]" class="form-control" id="evidenceType[{$l}]">
                                [{foreach from=$evidenceTypes item=i key=k}]
                                    <option value="[{$i|replace:'EVIDENCE_TYPE_':''}]">
                                        [{oxmultilang ident="OXPS_PAYPAL_"|cat:$k}]
                                    </option>
                                [{/foreach}]
                            </select>
                        </div>
