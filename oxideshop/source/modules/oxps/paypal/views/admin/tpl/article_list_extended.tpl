...
<td valign="top" class="[{$listclass}][{if $oView->isSubscriptionProduct($listitem->oxarticles__oxid->value)}] active[{/if}]" height="15"><div class="listitemfloating">&nbsp</a></div></td>
