    ...
    <div class="row">
        <div class="col-sm-12">
            <table class="table table-sm">
                <thead>
                    <tr>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_SUBSCRIPTION_TRANSACTION_ID"}]</th>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_SUBSCRIPTION_TRANSACTION_DATE"}]</th>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_SUBSCRIPTION_TRANSACTION_STATUS"}]</th>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_FULL_NAME"}]</th>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_EMAIL"}]</th>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_SUBSCRIPTION_TRANSACTION_GROSS_AMOUNT"}]</th>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_SUBSCRIPTION_TRANSACTION_NET_AMOUNT"}]</th>
                        <th>[{oxmultilang ident="OXPS_PAYPAL_SUBSCRIPTION_TRANSACTION_FEE_AMOUNT"}]</th>
                    </tr>
                </thead>
                <tbody>
                    [{if $transactions}]
