...
<div class="container-fluid">
    ...
    <div id="results">
        <table class="table table-sm">
            <thead>
                <tr>
                    <th>[{oxmultilang ident="OXPS_PAYPAL_ACCOUNT_ID"}]</th>
                    <th>[{oxmultilang ident="OXPS_PAYPAL_TRANSACTION_ID"}]</th>
                    <th>[{oxmultilang ident="OXPS_PAYPAL_INITIATION_DATE"}]</th>
                    <th>[{oxmultilang ident="OXPS_PAYPAL_UPDATED_DATE"}]</th>
                    <th colspan="2">[{oxmultilang ident="OXPS_PAYPAL_TRANSACTION_STATUS"}]</th>
                </tr>
            </thead>
            <tbody>
