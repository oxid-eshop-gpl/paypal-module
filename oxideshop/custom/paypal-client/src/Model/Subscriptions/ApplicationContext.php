...
class ApplicationContext implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->brand_name) || Assert::minLength($this->brand_name, 1, "brand_name in ApplicationContext must have minlength of 1 $within");
        !isset($this->brand_name) || Assert::maxLength($this->brand_name, 127, "brand_name in ApplicationContext must have maxlength of 127 $within");
        !isset($this->locale) || Assert::minLength($this->locale, 2, "locale in ApplicationContext must have minlength of 2 $within");
        !isset($this->locale) || Assert::maxLength($this->locale, 10, "locale in ApplicationContext must have maxlength of 10 $within");
        !isset($this->shipping_preference) || Assert::minLength($this->shipping_preference, 1, "shipping_preference in ApplicationContext must have minlength of 1 $within");
        !isset($this->shipping_preference) || Assert::maxLength($this->shipping_preference, 24, "shipping_preference in ApplicationContext must have maxlength of 24 $within");
        !isset($this->user_action) || Assert::minLength($this->user_action, 1, "user_action in ApplicationContext must have minlength of 1 $within");
