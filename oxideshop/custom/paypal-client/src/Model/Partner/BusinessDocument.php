...
class BusinessDocument extends Document implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->type) || Assert::minLength($this->type, 1, "type in BusinessDocument must have minlength of 1 $within");
        !isset($this->type) || Assert::maxLength($this->type, 255, "type in BusinessDocument must have maxlength of 255 $within");
    }
