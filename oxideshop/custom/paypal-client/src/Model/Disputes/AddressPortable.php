...
class AddressPortable implements JsonSerializable
{
    ...
    public function validate()
    {
        ...
        assert(!isset($this->address_line_3) || strlen($this->address_line_3) <= 300);
        assert(!isset($this->admin_area_4) || strlen($this->admin_area_4) <= 300);
        assert(!isset($this->admin_area_3) || strlen($this->admin_area_3) <= 300);
        assert(!isset($this->admin_area_2) || strlen($this->admin_area_2) <= 300);
