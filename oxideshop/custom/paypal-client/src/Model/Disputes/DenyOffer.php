...
class DenyOffer implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->note) || Assert::minLength($this->note, 1, "note in DenyOffer must have minlength of 1 $within");
        !isset($this->note) || Assert::maxLength($this->note, 2000, "note in DenyOffer must have maxlength of 2000 $within");
    }
