 ...
 */
class Payer23 implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->name) || Assert::isInstanceOf(
            $this->name,
            Name::class,
            "name in Payer23 must be instance of Name $within"
        );
        !isset($this->name) ||  $this->name->validate(Payer23::class);
        !isset($this->email_address) || Assert::maxLength(
            $this->email_address,
            254,
            "email_address in Payer23 must have maxlength of 254 $within"
        );
        !isset($this->payer_id) || Assert::minLength(
            $this->payer_id,
            13,
            "payer_id in Payer23 must have minlength of 13 $within"
        );
        !isset($this->payer_id) || Assert::maxLength(
            $this->payer_id,
            13,
            "payer_id in Payer23 must have maxlength of 13 $within"
        );
    }
