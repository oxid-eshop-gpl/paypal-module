...
class CustomizedXUnsupportedNineEightNineFourApplicationContext implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->brand_name) || Assert::minLength(
            $this->brand_name,
            1,
            "brand_name in CustomizedXUnsupportedNineEightNineFourApplicationContext must have minlength of 1 $within"
        );
        !isset($this->brand_name) || Assert::maxLength(
            $this->brand_name,
            127,
            "brand_name in CustomizedXUnsupportedNineEightNineFourApplicationContext must have maxlength of 127 $within"
        );
        !isset($this->locale) || Assert::minLength(
            $this->locale,
            2,
            "locale in CustomizedXUnsupportedNineEightNineFourApplicationContext must have minlength of 2 $within"
        );
        !isset($this->locale) || Assert::maxLength(
            $this->locale,
            10,
            "locale in CustomizedXUnsupportedNineEightNineFourApplicationContext must have maxlength of 10 $within"
        );
        !isset($this->shipping_preference) || Assert::minLength(
            $this->shipping_preference,
            1,
            "shipping_preference in CustomizedXUnsupportedNineEightNineFourApplicationContext must have minlength of 1 $within"
        );
        !isset($this->shipping_preference) || Assert::maxLength(
            $this->shipping_preference,
            24,
            "shipping_preference in CustomizedXUnsupportedNineEightNineFourApplicationContext must have maxlength of 24 $within"
        );
        !isset($this->payment_method) || Assert::isInstanceOf(
            $this->payment_method,
            PaymentMethod::class,
            "payment_method in CustomizedXUnsupportedNineEightNineFourApplicationContext must be instance of PaymentMethod $within"
        );
        ...
        Assert::minLength(
            $this->return_url,
            10,
            "return_url in CustomizedXUnsupportedNineEightNineFourApplicationContext must have minlength of 10 $within"
        );
        Assert::maxLength(
            $this->return_url,
            4000,
            "return_url in CustomizedXUnsupportedNineEightNineFourApplicationContext must have maxlength of 4000 $within"
        );
        ...
        Assert::minLength(
            $this->cancel_url,
            10,
            "cancel_url in CustomizedXUnsupportedNineEightNineFourApplicationContext must have minlength of 10 $within"
        );
        Assert::maxLength(
            $this->cancel_url,
            4000,
            "cancel_url in CustomizedXUnsupportedNineEightNineFourApplicationContext must have maxlength of 4000 $within"
        );
    }
