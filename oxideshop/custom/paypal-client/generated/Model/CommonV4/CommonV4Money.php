 ...
 */
class CommonV4Money implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        Assert::notNull($this->currency_code, "currency_code in CommonV4Money must not be NULL $within");
        Assert::minLength(
            $this->currency_code,
            3,
            "currency_code in CommonV4Money must have minlength of 3 $within"
        );
        Assert::maxLength(
            $this->currency_code,
            3,
            "currency_code in CommonV4Money must have maxlength of 3 $within"
        );
        Assert::notNull($this->value, "value in CommonV4Money must not be NULL $within");
        Assert::maxLength(
            $this->value,
            32,
            "value in CommonV4Money must have maxlength of 32 $within"
        );
    }
