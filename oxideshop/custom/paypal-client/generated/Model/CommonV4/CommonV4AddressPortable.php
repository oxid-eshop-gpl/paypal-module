 ...
 */
class CommonV4AddressPortable implements JsonSerializable
{
    use BaseModel;
     ...
     *
     * @var CommonVFourAddressPortableAddressDetails | null
     */
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->address_line_1) || Assert::maxLength(
            $this->address_line_1,
            300,
            "address_line_1 in CommonV4AddressPortable must have maxlength of 300 $within"
        );
        !isset($this->address_line_2) || Assert::maxLength(
            $this->address_line_2,
            300,
            "address_line_2 in CommonV4AddressPortable must have maxlength of 300 $within"
        );
        !isset($this->address_line_3) || Assert::maxLength(
            $this->address_line_3,
            100,
            "address_line_3 in CommonV4AddressPortable must have maxlength of 100 $within"
        );
        !isset($this->admin_area_4) || Assert::maxLength(
            $this->admin_area_4,
            100,
            "admin_area_4 in CommonV4AddressPortable must have maxlength of 100 $within"
        );
        !isset($this->admin_area_3) || Assert::maxLength(
            $this->admin_area_3,
            100,
            "admin_area_3 in CommonV4AddressPortable must have maxlength of 100 $within"
        );
        !isset($this->admin_area_2) || Assert::maxLength(
            $this->admin_area_2,
            120,
            "admin_area_2 in CommonV4AddressPortable must have maxlength of 120 $within"
        );
        !isset($this->admin_area_1) || Assert::maxLength(
            $this->admin_area_1,
            300,
            "admin_area_1 in CommonV4AddressPortable must have maxlength of 300 $within"
        );
        !isset($this->postal_code) || Assert::maxLength(
            $this->postal_code,
            60,
            "postal_code in CommonV4AddressPortable must have maxlength of 60 $within"
        );
        Assert::notNull($this->country_code, "country_code in CommonV4AddressPortable must not be NULL $within");
        Assert::minLength(
            $this->country_code,
            2,
            "country_code in CommonV4AddressPortable must have minlength of 2 $within"
        );
        Assert::maxLength(
            $this->country_code,
            2,
            "country_code in CommonV4AddressPortable must have maxlength of 2 $within"
        );
        !isset($this->address_details) || Assert::isInstanceOf(
            $this->address_details,
            CommonVFourAddressPortableAddressDetails::class,
            "address_details in CommonV4AddressPortable must be instance of CommonVFourAddressPortableAddressDetails $within"
        );
        !isset($this->address_details) ||  $this->address_details->validate(CommonV4AddressPortable::class);
    }
    ...
    private function map(array $data)
    {
        ...
        if (isset($data['address_details'])) {
            $this->address_details = new CommonVFourAddressPortableAddressDetails($data['address_details']);
        }
    }
