 ...
 */
class CommonV4Phone implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        Assert::notNull($this->country_code, "country_code in CommonV4Phone must not be NULL $within");
        Assert::minLength(
            $this->country_code,
            1,
            "country_code in CommonV4Phone must have minlength of 1 $within"
        );
        Assert::maxLength(
            $this->country_code,
            3,
            "country_code in CommonV4Phone must have maxlength of 3 $within"
        );
        Assert::notNull($this->national_number, "national_number in CommonV4Phone must not be NULL $within");
        Assert::minLength(
            $this->national_number,
            1,
            "national_number in CommonV4Phone must have minlength of 1 $within"
        );
        Assert::maxLength(
            $this->national_number,
            14,
            "national_number in CommonV4Phone must have maxlength of 14 $within"
        );
        !isset($this->extension_number) || Assert::minLength(
            $this->extension_number,
            1,
            "extension_number in CommonV4Phone must have minlength of 1 $within"
        );
        !isset($this->extension_number) || Assert::maxLength(
            $this->extension_number,
            15,
            "extension_number in CommonV4Phone must have maxlength of 15 $within"
        );
    }
