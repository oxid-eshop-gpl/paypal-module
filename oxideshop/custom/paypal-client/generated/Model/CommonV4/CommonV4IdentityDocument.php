 ...
 */
class CommonV4IdentityDocument implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->type) || Assert::minLength(
            $this->type,
            1,
            "type in CommonV4IdentityDocument must have minlength of 1 $within"
        );
        !isset($this->type) || Assert::maxLength(
            $this->type,
            255,
            "type in CommonV4IdentityDocument must have maxlength of 255 $within"
        );
        !isset($this->issuer) || Assert::isInstanceOf(
            $this->issuer,
            CommonV4DocumentIssuer::class,
            "issuer in CommonV4IdentityDocument must be instance of CommonV4DocumentIssuer $within"
        );
        !isset($this->issuer) ||  $this->issuer->validate(CommonV4IdentityDocument::class);
        !isset($this->id_number) || Assert::minLength(
            $this->id_number,
            1,
            "id_number in CommonV4IdentityDocument must have minlength of 1 $within"
        );
        !isset($this->id_number) || Assert::maxLength(
            $this->id_number,
            100,
            "id_number in CommonV4IdentityDocument must have maxlength of 100 $within"
        );
        !isset($this->issued_date) || Assert::minLength(
            $this->issued_date,
            10,
            "issued_date in CommonV4IdentityDocument must have minlength of 10 $within"
        );
        !isset($this->issued_date) || Assert::maxLength(
            $this->issued_date,
            10,
            "issued_date in CommonV4IdentityDocument must have maxlength of 10 $within"
        );
        !isset($this->expiration_date) || Assert::minLength(
            $this->expiration_date,
            10,
            "expiration_date in CommonV4IdentityDocument must have minlength of 10 $within"
        );
        !isset($this->expiration_date) || Assert::maxLength(
            $this->expiration_date,
            10,
            "expiration_date in CommonV4IdentityDocument must have maxlength of 10 $within"
        );
    }
