 ...
 */
class CommonV4DocumentIssuer implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        Assert::notNull($this->country_code, "country_code in CommonV4DocumentIssuer must not be NULL $within");
        Assert::minLength(
            $this->country_code,
            2,
            "country_code in CommonV4DocumentIssuer must have minlength of 2 $within"
        );
        Assert::maxLength(
            $this->country_code,
            2,
            "country_code in CommonV4DocumentIssuer must have maxlength of 2 $within"
        );
        !isset($this->province_code) || Assert::minLength(
            $this->province_code,
            5,
            "province_code in CommonV4DocumentIssuer must have minlength of 5 $within"
        );
        !isset($this->province_code) || Assert::maxLength(
            $this->province_code,
            6,
            "province_code in CommonV4DocumentIssuer must have maxlength of 6 $within"
        );
        !isset($this->authority) || Assert::minLength(
            $this->authority,
            1,
            "authority in CommonV4DocumentIssuer must have minlength of 1 $within"
        );
        !isset($this->authority) || Assert::maxLength(
            $this->authority,
            255,
            "authority in CommonV4DocumentIssuer must have maxlength of 255 $within"
        );
    }
