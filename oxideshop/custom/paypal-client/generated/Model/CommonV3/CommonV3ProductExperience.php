 ...
 */
class CommonV3ProductExperience implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->user_experience_flow) || Assert::minLength(
            ...
            1,
            "user_experience_flow in CommonV3ProductExperience must have minlength of 1 $within"
        );
        !isset($this->user_experience_flow) || Assert::maxLength(
            $this->user_experience_flow,
            255,
            "user_experience_flow in CommonV3ProductExperience must have maxlength of 255 $within"
        );
        !isset($this->entry_point) || Assert::minLength(
            $this->entry_point,
            1,
            "entry_point in CommonV3ProductExperience must have minlength of 1 $within"
        );
        !isset($this->entry_point) || Assert::maxLength(
            $this->entry_point,
            255,
            "entry_point in CommonV3ProductExperience must have maxlength of 255 $within"
        );
        !isset($this->payment_method) || Assert::minLength(
            $this->payment_method,
            1,
            "payment_method in CommonV3ProductExperience must have minlength of 1 $within"
        );
        !isset($this->payment_method) || Assert::maxLength(
            $this->payment_method,
            255,
            "payment_method in CommonV3ProductExperience must have maxlength of 255 $within"
        );
        !isset($this->channel) || Assert::minLength(
            $this->channel,
            1,
            "channel in CommonV3ProductExperience must have minlength of 1 $within"
        );
        !isset($this->channel) || Assert::maxLength(
            $this->channel,
            255,
            "channel in CommonV3ProductExperience must have maxlength of 255 $within"
        );
        !isset($this->product_flow) || Assert::minLength(
            $this->product_flow,
            1,
            "product_flow in CommonV3ProductExperience must have minlength of 1 $within"
        );
        !isset($this->product_flow) || Assert::maxLength(
            $this->product_flow,
            255,
            "product_flow in CommonV3ProductExperience must have maxlength of 255 $within"
        );
    }
