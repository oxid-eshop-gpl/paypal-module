 ...
 */
class CommonV3Name implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->prefix) || Assert::maxLength(
            $this->prefix,
            140,
            "prefix in CommonV3Name must have maxlength of 140 $within"
        );
        !isset($this->given_name) || Assert::maxLength(
            $this->given_name,
            140,
            "given_name in CommonV3Name must have maxlength of 140 $within"
        );
        !isset($this->surname) || Assert::maxLength(
            $this->surname,
            140,
            "surname in CommonV3Name must have maxlength of 140 $within"
        );
        !isset($this->middle_name) || Assert::maxLength(
            $this->middle_name,
            140,
            "middle_name in CommonV3Name must have maxlength of 140 $within"
        );
        !isset($this->suffix) || Assert::maxLength(
            $this->suffix,
            140,
            "suffix in CommonV3Name must have maxlength of 140 $within"
        );
        !isset($this->alternate_full_name) || Assert::maxLength(
            $this->alternate_full_name,
            300,
            "alternate_full_name in CommonV3Name must have maxlength of 300 $within"
        );
        !isset($this->full_name) || Assert::maxLength(
            $this->full_name,
            300,
            "full_name in CommonV3Name must have maxlength of 300 $within"
        );
    }
