 ...
 */
class CommonV3ClientConfiguration implements JsonSerializable
{
    use BaseModel;
     ...
     *
     * @var CommonV3ProductExperience | null
     */
    public $experience;
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->product_code) || Assert::minLength(
            $this->product_code,
            1,
            "product_code in CommonV3ClientConfiguration must have minlength of 1 $within"
        );
        !isset($this->product_code) || Assert::maxLength(
            $this->product_code,
            255,
            "product_code in CommonV3ClientConfiguration must have maxlength of 255 $within"
        );
        !isset($this->product_feature) || Assert::minLength(
            $this->product_feature,
            1,
            "product_feature in CommonV3ClientConfiguration must have minlength of 1 $within"
        );
        !isset($this->product_feature) || Assert::maxLength(
            $this->product_feature,
            255,
            "product_feature in CommonV3ClientConfiguration must have maxlength of 255 $within"
        );
        !isset($this->api) || Assert::minLength(
            $this->api,
            1,
            "api in CommonV3ClientConfiguration must have minlength of 1 $within"
        );
        !isset($this->api) || Assert::maxLength(
            $this->api,
            255,
            "api in CommonV3ClientConfiguration must have maxlength of 255 $within"
        );
        !isset($this->integration_artifact) || Assert::minLength(
            $this->integration_artifact,
            1,
            "integration_artifact in CommonV3ClientConfiguration must have minlength of 1 $within"
        );
        !isset($this->integration_artifact) || Assert::maxLength(
            $this->integration_artifact,
            255,
            "integration_artifact in CommonV3ClientConfiguration must have maxlength of 255 $within"
        );
        !isset($this->experience) || Assert::isInstanceOf(
            $this->experience,
            CommonV3ProductExperience::class,
            "experience in CommonV3ClientConfiguration must be instance of CommonV3ProductExperience $within"
        );
        !isset($this->experience) ||  $this->experience->validate(CommonV3ClientConfiguration::class);
    }
    ...
    private function map(array $data)
    {
        ...
        if (isset($data['experience'])) {
            $this->experience = new CommonV3ProductExperience($data['experience']);
        }
    }
