...
class BillingExperiencePreference implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->experience_id) || Assert::minLength(
            $this->experience_id,
            1,
            "experience_id in BillingExperiencePreference must have minlength of 1 $within"
        );
        !isset($this->experience_id) || Assert::maxLength(
            $this->experience_id,
            20,
            "experience_id in BillingExperiencePreference must have maxlength of 20 $within"
        );
    }
