...
class ClassicApiIntegration implements JsonSerializable
{
     ...
     *
     * @var ClassicApiIntegrationThirdPartyDetails | null
     */
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->integration_type) || Assert::minLength(
            ...
            1,
            "integration_type in ClassicApiIntegration must have minlength of 1 $within"
        );
        !isset($this->integration_type) || Assert::maxLength(
            $this->integration_type,
            128,
            "integration_type in ClassicApiIntegration must have maxlength of 128 $within"
        );
        !isset($this->third_party_details) || Assert::isInstanceOf(
            $this->third_party_details,
            ClassicApiIntegrationThirdPartyDetails::class,
            "third_party_details in ClassicApiIntegration must be instance of ClassicApiIntegrationThirdPartyDetails $within"
        );
        ...
        !isset($this->first_party_details) || Assert::minLength(
            ...
            1,
            "first_party_details in ClassicApiIntegration must have minlength of 1 $within"
        );
        !isset($this->first_party_details) || Assert::maxLength(
            $this->first_party_details,
            128,
            "first_party_details in ClassicApiIntegration must have maxlength of 128 $within"
        );
    }
