...
class ChangeReason implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->reason) || Assert::minLength(
            $this->reason,
            1,
            "reason in ChangeReason must have minlength of 1 $within"
        );
        !isset($this->reason) || Assert::maxLength(
            $this->reason,
            255,
            "reason in ChangeReason must have maxlength of 255 $within"
        );
        !isset($this->note) || Assert::maxLength(
            $this->note,
            1048576,
            "note in ChangeReason must have maxlength of 1048576 $within"
        );
        !isset($this->extensions) || Assert::isInstanceOf(
            $this->extensions,
            Extensions::class,
            "extensions in ChangeReason must be instance of Extensions $within"
        );
