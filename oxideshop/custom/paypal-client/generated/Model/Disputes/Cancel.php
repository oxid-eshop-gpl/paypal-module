...
class Cancel implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->note) || Assert::maxLength(
            $this->note,
            1048576,
            "note in Cancel must have maxlength of 1048576 $within"
        );
        !isset($this->transaction_ids) || Assert::isArray(
            $this->transaction_ids,
            "transaction_ids in Cancel must be array $within"
        );
        !isset($this->cancellation_reason) || Assert::minLength(
            $this->cancellation_reason,
            1,
            "cancellation_reason in Cancel must have minlength of 1 $within"
        );
        !isset($this->cancellation_reason) || Assert::maxLength(
            $this->cancellation_reason,
            255,
            "cancellation_reason in Cancel must have maxlength of 255 $within"
        );
    }
