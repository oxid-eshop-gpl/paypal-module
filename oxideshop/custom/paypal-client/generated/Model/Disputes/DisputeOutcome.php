...
class DisputeOutcome implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->outcome_code) || Assert::minLength(
            $this->outcome_code,
            1,
            "outcome_code in DisputeOutcome must have minlength of 1 $within"
        );
        !isset($this->outcome_code) || Assert::maxLength(
            $this->outcome_code,
            255,
            "outcome_code in DisputeOutcome must have maxlength of 255 $within"
        );
        !isset($this->outcome_reason) || Assert::minLength(
            $this->outcome_reason,
            1,
            "outcome_reason in DisputeOutcome must have minlength of 1 $within"
        );
        !isset($this->outcome_reason) || Assert::maxLength(
            $this->outcome_reason,
            2000,
            "outcome_reason in DisputeOutcome must have maxlength of 2000 $within"
        );
