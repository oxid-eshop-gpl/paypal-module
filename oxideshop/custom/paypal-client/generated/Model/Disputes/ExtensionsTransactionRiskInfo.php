...
class ExtensionsTransactionRiskInfo implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->id) || Assert::minLength(
            $this->id,
            1,
            "id in ExtensionsTransactionRiskInfo must have minlength of 1 $within"
        );
        !isset($this->id) || Assert::maxLength(
            $this->id,
            255,
            "id in ExtensionsTransactionRiskInfo must have maxlength of 255 $within"
        );
        !isset($this->reason) || Assert::minLength(
            $this->reason,
            1,
            "reason in ExtensionsTransactionRiskInfo must have minlength of 1 $within"
        );
        !isset($this->reason) || Assert::maxLength(
            $this->reason,
            2000,
            "reason in ExtensionsTransactionRiskInfo must have maxlength of 2000 $within"
        );
    }
