...
class Dispute implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->id) || Assert::minLength(
            $this->id,
            1,
            "id in Dispute must have minlength of 1 $within"
        );
        !isset($this->id) || Assert::maxLength(
            $this->id,
            255,
            "id in Dispute must have maxlength of 255 $within"
        );
        ...
        !isset($this->reference_disputes) || Assert::isArray(
            ...
            "reference_disputes in Dispute must be array $within"
        );
        ...
        !isset($this->transaction) || Assert::isInstanceOf(
            $this->transaction,
            Transaction::class,
            "transaction in Dispute must be instance of Transaction $within"
        );
        !isset($this->transaction) ||  $this->transaction->validate(Dispute::class);
        ...
        !isset($this->sub_reason) || Assert::minLength(
            $this->sub_reason,
            1,
            "sub_reason in Dispute must have minlength of 1 $within"
        );
        !isset($this->sub_reason) || Assert::maxLength(
            $this->sub_reason,
            255,
            "sub_reason in Dispute must have maxlength of 255 $within"
        );
        ...
        !isset($this->refund_info) || Assert::isInstanceOf(
            $this->refund_info,
            RefundInfo::class,
            "refund_info in Dispute must be instance of RefundInfo $within"
        );
        !isset($this->refund_info) ||  $this->refund_info->validate(Dispute::class);
        !isset($this->outcome) || Assert::isInstanceOf(
            $this->outcome,
            Outcome::class,
            "outcome in Dispute must be instance of Outcome $within"
        );
        !isset($this->outcome) ||  $this->outcome->validate(Dispute::class);
