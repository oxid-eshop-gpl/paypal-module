...
class RefundInfo implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        Assert::minLength(
            $this->recipient,
            1,
            "recipient in RefundInfo must have minlength of 1 $within"
        );
        Assert::maxLength(
            $this->recipient,
            255,
            "recipient in RefundInfo must have maxlength of 255 $within"
        );
        ...
        Assert::minLength(
            $this->create_time,
            20,
            "create_time in RefundInfo must have minlength of 20 $within"
        );
        Assert::maxLength(
            $this->create_time,
            64,
            "create_time in RefundInfo must have maxlength of 64 $within"
        );
        !isset($this->transaction_id) || Assert::minLength(
            $this->transaction_id,
            1,
            "transaction_id in RefundInfo must have minlength of 1 $within"
        );
        !isset($this->transaction_id) || Assert::maxLength(
            $this->transaction_id,
            255,
            "transaction_id in RefundInfo must have maxlength of 255 $within"
        );
        Assert::notNull($this->payout_type, "payout_type in RefundInfo must not be NULL $within");
        Assert::minLength(
            $this->payout_type,
            1,
            "payout_type in RefundInfo must have minlength of 1 $within"
        );
        Assert::maxLength(
            $this->payout_type,
            255,
            "payout_type in RefundInfo must have maxlength of 255 $within"
        );
        ...
        Assert::minLength(
            ...
            1,
            "transaction_source in RefundInfo must have minlength of 1 $within"
        );
        Assert::maxLength(
            $this->transaction_source,
            255,
            "transaction_source in RefundInfo must have maxlength of 255 $within"
        );
    }
