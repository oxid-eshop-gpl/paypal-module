...
class ActivityEntityInfo implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->last_known_valid_transaction_date) || Assert::minLength(
            ...
            20,
            "last_known_valid_transaction_date in ActivityEntityInfo must have minlength of 20 $within"
        );
        !isset($this->last_known_valid_transaction_date) || Assert::maxLength(
            $this->last_known_valid_transaction_date,
            64,
            "last_known_valid_transaction_date in ActivityEntityInfo must have maxlength of 64 $within"
        );
    }
