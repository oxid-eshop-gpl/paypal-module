...
class SupportingInfo implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->notes) || Assert::minLength(
            $this->notes,
            1,
            "notes in SupportingInfo must have minlength of 1 $within"
        );
        !isset($this->notes) || Assert::maxLength(
            $this->notes,
            2000,
            "notes in SupportingInfo must have maxlength of 2000 $within"
        );
        ...
        !isset($this->source) || Assert::minLength(
            $this->source,
            1,
            "source in SupportingInfo must have minlength of 1 $within"
        );
        !isset($this->source) || Assert::maxLength(
            $this->source,
            255,
            "source in SupportingInfo must have maxlength of 255 $within"
        );
        !isset($this->provided_time) || Assert::minLength(
            $this->provided_time,
            20,
            "provided_time in SupportingInfo must have minlength of 20 $within"
        );
        !isset($this->provided_time) || Assert::maxLength(
            $this->provided_time,
            64,
            "provided_time in SupportingInfo must have maxlength of 64 $within"
        );
    }
