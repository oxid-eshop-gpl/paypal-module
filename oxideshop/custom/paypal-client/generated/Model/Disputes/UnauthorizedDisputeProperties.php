...
class UnauthorizedDisputeProperties implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->review_sla) || Assert::minLength(
            $this->review_sla,
            20,
            "review_sla in UnauthorizedDisputeProperties must have minlength of 20 $within"
        );
        !isset($this->review_sla) || Assert::maxLength(
            $this->review_sla,
            64,
            "review_sla in UnauthorizedDisputeProperties must have maxlength of 64 $within"
        );
        !isset($this->rejected_dispute_transactions) || Assert::isArray(
            $this->rejected_dispute_transactions,
            "rejected_dispute_transactions in UnauthorizedDisputeProperties must be array $within"
        );
    }
