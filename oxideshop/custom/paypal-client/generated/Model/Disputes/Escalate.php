...
class Escalate implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        Assert::minLength(
            $this->note,
            1,
            "note in Escalate must have minlength of 1 $within"
        );
        Assert::maxLength(
            $this->note,
            2000,
            "note in Escalate must have maxlength of 2000 $within"
        );
        !isset($this->buyer_escalation_reason) || Assert::minLength(
            $this->buyer_escalation_reason,
            1,
            "buyer_escalation_reason in Escalate must have minlength of 1 $within"
        );
        !isset($this->buyer_escalation_reason) || Assert::maxLength(
            $this->buyer_escalation_reason,
            255,
            "buyer_escalation_reason in Escalate must have maxlength of 255 $within"
        );
