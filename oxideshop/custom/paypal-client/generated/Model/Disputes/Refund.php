...
class Refund implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->transaction_time) || Assert::minLength(
            ...
            20,
            "transaction_time in Refund must have minlength of 20 $within"
        );
        !isset($this->transaction_time) || Assert::maxLength(
            $this->transaction_time,
            64,
            "transaction_time in Refund must have maxlength of 64 $within"
        );
        !isset($this->transaction_id) || Assert::minLength(
            $this->transaction_id,
            1,
            "transaction_id in Refund must have minlength of 1 $within"
        );
        !isset($this->transaction_id) || Assert::maxLength(
            $this->transaction_id,
            255,
            "transaction_id in Refund must have maxlength of 255 $within"
        );
        !isset($this->invoice_number) || Assert::minLength(
            $this->invoice_number,
            1,
            "invoice_number in Refund must have minlength of 1 $within"
        );
        !isset($this->invoice_number) || Assert::maxLength(
            $this->invoice_number,
            127,
            "invoice_number in Refund must have maxlength of 127 $within"
        );
    }
