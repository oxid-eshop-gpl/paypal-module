...
class PaymentByOtherMeans implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->payment_method) || Assert::minLength(
            $this->payment_method,
            1,
            "payment_method in PaymentByOtherMeans must have minlength of 1 $within"
        );
        !isset($this->payment_method) || Assert::maxLength(
            $this->payment_method,
            255,
            "payment_method in PaymentByOtherMeans must have maxlength of 255 $within"
        );
        !isset($this->payment_instrument_suffix) || Assert::minLength(
            $this->payment_instrument_suffix,
            2,
            "payment_instrument_suffix in PaymentByOtherMeans must have minlength of 2 $within"
        );
        !isset($this->payment_instrument_suffix) || Assert::maxLength(
            $this->payment_instrument_suffix,
            4,
            "payment_instrument_suffix in PaymentByOtherMeans must have maxlength of 4 $within"
        );
    }
