...
class EligibleDisputeReason implements JsonSerializable
{
     ...
     *
     * @var EligibleDisputeReasonAllowableLifeCycle | null
     */
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->dispute_reason) || Assert::minLength(
            $this->dispute_reason,
            1,
            "dispute_reason in EligibleDisputeReason must have minlength of 1 $within"
        );
        !isset($this->dispute_reason) || Assert::maxLength(
            $this->dispute_reason,
            255,
            "dispute_reason in EligibleDisputeReason must have maxlength of 255 $within"
        );
        !isset($this->allowable_life_cycle) || Assert::isInstanceOf(
            $this->allowable_life_cycle,
            EligibleDisputeReasonAllowableLifeCycle::class,
            "allowable_life_cycle in EligibleDisputeReason must be instance of EligibleDisputeReasonAllowableLifeCycle $within"
        );
