...
class EligibilityResponse implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->allowable_life_cycle) || Assert::minLength(
            ...
            1,
            "allowable_life_cycle in EligibilityResponse must have minlength of 1 $within"
        );
        !isset($this->allowable_life_cycle) || Assert::maxLength(
            $this->allowable_life_cycle,
            255,
            "allowable_life_cycle in EligibilityResponse must have maxlength of 255 $within"
        );
        !isset($this->ineligibility_reason) || Assert::minLength(
            $this->ineligibility_reason,
            1,
            "ineligibility_reason in EligibilityResponse must have minlength of 1 $within"
        );
        !isset($this->ineligibility_reason) || Assert::maxLength(
            $this->ineligibility_reason,
            255,
            "ineligibility_reason in EligibilityResponse must have maxlength of 255 $within"
        );
