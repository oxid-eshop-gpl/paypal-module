...
class IneligibleDisputeReason implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->dispute_reason) || Assert::minLength(
            $this->dispute_reason,
            1,
            "dispute_reason in IneligibleDisputeReason must have minlength of 1 $within"
        );
        !isset($this->dispute_reason) || Assert::maxLength(
            $this->dispute_reason,
            255,
            "dispute_reason in IneligibleDisputeReason must have maxlength of 255 $within"
        );
        !isset($this->ineligibility_reason) || Assert::minLength(
            $this->ineligibility_reason,
            1,
            "ineligibility_reason in IneligibleDisputeReason must have minlength of 1 $within"
        );
        !isset($this->ineligibility_reason) || Assert::maxLength(
            $this->ineligibility_reason,
            2000,
            "ineligibility_reason in IneligibleDisputeReason must have maxlength of 2000 $within"
        );
    }
