...
class PatchRequestFactory
{
    ...
    public function getRequest(
        ...
        $this->getAmountPatch();
        if ($shopOrderInvoice) {
            $this->getInvoiceIdPatch($shopOrderInvoice);
        }
